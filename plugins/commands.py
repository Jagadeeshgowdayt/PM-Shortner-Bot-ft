...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = buttons = [ InlineKeyboardButton('send me movie name')]
    ...
    if len(message.command) != 2:
        buttons = [ InlineKeyboardButton('send me movie name')]
        reply_markup = InlineKeyboardMarkup(buttons)
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton('⚜️ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ⚜️', url="CHNL_LNK")
                       ],[
                          InlineKeyboardButton("🔱ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ🔱", url="CHNL_LNK")
                         ]
                        ]
                    )
                )
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton('🔰ᴍᴀɪɴ ɢʀᴏᴜᴘ', url=CHNL_LNK),
                          InlineKeyboardButton('⚜️ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ', url="CHNL_LNK")
                       ],[
                          InlineKeyboardButton("🔱ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ🔱", url="CHNL_LNK")
                         ]
                        ]
